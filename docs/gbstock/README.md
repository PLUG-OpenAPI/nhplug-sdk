...
| 해외주식 미체결내역 | POST | `/gbstock/inquiry/v1/unexecuted` | gbstockInquiryUnexecuted |
...
운영 나무 Endpoint: `wss://api.nhplug.com:7080` · 구독 메시지·인증은 [openapi.json](https://www.nhplug.com/openapi-docs/gbstock/openapi.json) 의 `x-realtime-channels.protocol` 참조.

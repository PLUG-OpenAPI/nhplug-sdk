...
| 선물옵션 정정취소주문주간취소 | POST | `/krfuture/order/v1/dayCancel` | krfutureOrderDayCancel |
| 선물옵션 정정취소주문주간정정 | POST | `/krfuture/order/v1/dayModify` | krfutureOrderDayModify |
| 선물옵션 정정취소주문야간취소 | POST | `/krfuture/order/v1/nightCancel` | krfutureOrderNightCancel |
| 선물옵션 정정취소주문야간정정 | POST | `/krfuture/order/v1/nightModify` | krfutureOrderNightModify |
| 선물옵션 주문야간 | POST | `/krfuture/order/v1/nightNight` | krfutureOrderNightNight |
...
| 선물옵션 시세야간 | POST | `/krfuture/quote/v1/night` | krfutureQuoteNight |
| 선물옵션기간별시세(일/주/월/년)야간 | POST | `/krfuture/quote/v1/nightPeriod` | krfutureQuoteNightPeriod |
...
운영 나무 Endpoint: `wss://api.nhplug.com:7070` · 구독 메시지·인증은 [openapi.json](https://www.nhplug.com/openapi-docs/krfuture/openapi.json) 의 `x-realtime-channels.protocol` 참조.
...
| 지수옵션 실시간호가KQ150 | `xH` | `opitem`(종목코드) | 36 |
| 지수옵션 실시간호가미니 | `rH` | `opitem`(종목코드) | 36 |
| 지수옵션 실시간체결가KP200 | `o2` | `opitem`(종목코드) | 53 |
| 지수옵션 실시간체결가KQ150 | `xC` | `opitem`(종목코드) | 53 |
| 지수옵션 실시간체결가미니 | `rC` | `opitem`(종목코드) | 53 |
| 지수옵션 실시간예상체결KP200 | `oE` | `opitem`(종목코드) | 8 |
| 지수옵션 실시간예상체결KQ150 | `xE` | `opitem`(종목코드) | 8 |
| 지수옵션 실시간예상체결미니 | `rE` | `opitem`(종목코드) | 8 |
...
| KRX야간선물 실시간호가KQ150 | `2a` | `fuitem`(종목코드) | 36 |
| KRX야간선물 실시간호가미니 | `4a` | `fuitem`(종목코드) | 36 |
| KRX야간선물 실시간체결가KP200 | `1c` | `fuitem`(종목코드) | 31 |
| KRX야간선물 실시간체결가KQ150 | `2c` | `fuitem`(종목코드) | 31 |
| KRX야간선물 실시간체결가미니 | `4c` | `fuitem`(종목코드) | 31 |
| KRX야간선물 실시간예상체결KP200 | `1b` | `fuitem`(종목코드) | 8 |
| KRX야간선물 실시간예상체결KQ150 | `2b` | `fuitem`(종목코드) | 8 |
| KRX야간선물 실시간예상체결미니 | `4b` | `fuitem`(종목코드) | 8 |
| KRX야간옵션 실시간호가KP200 | `5a` | `opitem`(종목코드) | 36 |
| KRX야간옵션 실시간호가KQ150 | `7a` | `opitem`(종목코드) | 36 |
| KRX야간옵션 실시간호가미니 | `6a` | `opitem`(종목코드) | 36 |
| KRX야간옵션 실시간체결가KP200 | `5c` | `opitem`(종목코드) | 55 |
| KRX야간옵션 실시간체결가KQ150 | `7c` | `opitem`(종목코드) | 55 |
| KRX야간옵션 실시간체결가미니 | `6c` | `opitem`(종목코드) | 55 |
| KRX야간옵션 실시간예상체결KP200 | `5b` | `opitem`(종목코드) | 8 |
| KRX야간옵션 실시간예상체결KQ150 | `7b` | `opitem`(종목코드) | 8 |
| KRX야간옵션 실시간예상체결미니 | `6b` | `opitem`(종목코드) | 8 |

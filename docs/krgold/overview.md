...
NH투자증권 Open API 의 **국내금현물 (KR Gold)** 자산군은 주문, 계좌·자산 조회, 시세, 실시간 스트리밍을 제공합니다. (기준: API명세서 260703 / 나무 환경)
...
전체 목록·operationId 는 [README.md](https://www.nhplug.com/openapi-docs/krgold/README.md), 필드·스키마는 [openapi.json](https://www.nhplug.com/openapi-docs/krgold/openapi.json) 정본 참조.
...
- 본 문서는 **국내금현물 (KR Gold)** 자산군, API명세서 **260703** / **나무** 환경 기준입니다.

/****************************************************************************
 * NH투자증권 종목마스터 — 해외파생 > 선물 > 홍콩선물
 *
 * @file      fucode_fhke_h.mst
 * @url       https://www.nhplug.com/instruments/fucode_fhke_h.mst
 * @record    283      // 레코드 크기(byte). 파일크기 % record == 0 이어야 함
 * @encoding  CP949
 * @padding   공백(0x20) 우측 · 레코드 끝 1바이트 LF(0x0A) · 파일 헤더 없음
 * @service   d6890
 * @note      fucode_h.mst 와 동일 구조. 버퍼 뒤에 append
 *

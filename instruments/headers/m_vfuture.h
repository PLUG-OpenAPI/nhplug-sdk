/****************************************************************************
 * NH투자증권 종목마스터 — 국내 선물 > 변동성지수선물
 *
 * @file      m_vfuture.mst
 * @url       https://www.nhplug.com/instruments/m_vfuture.mst
...
typedef struct
{
    ...
    char sName[20];                         /* @9    종목명 <hname[40] 중 앞 20B> */
    char dummy[21];                         /* @29   예비(dummy) + 레코드 종단자 <hname 잔여 + (LF)> */
}   VFUTURE;   /* sizeof = 50 */

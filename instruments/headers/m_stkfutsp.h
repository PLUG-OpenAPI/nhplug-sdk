/****************************************************************************
 * NH투자증권 종목마스터 — 국내 선물 > 주식선물 스프레드
 *
 * @file      m_stkfutsp.mst
 * @url       https://www.nhplug.com/instruments/m_stkfutsp.mst
...
typedef struct
{
    ...
    char sName[30];                         /* @9    종목명 <hname (30B로 절단)> | 원장 원본 hname[50] 을 30바이트로 잘라 기록 — 긴 종목명은 절단됨 */

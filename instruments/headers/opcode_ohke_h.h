/****************************************************************************
 * NH투자증권 종목마스터 — 해외파생 > 옵션 > 홍콩옵션
 *
 * @file      opcode_ohke_h.mst
 * @url       https://www.nhplug.com/instruments/opcode_ohke_h.mst
 * @record    259      // 레코드 크기(byte). 파일크기 % record == 0 이어야 함
 * @encoding  CP949
 * @padding   공백(0x20) 우측 · 레코드 끝 1바이트 LF(0x0A) · 파일 헤더 없음
 * @service   d6891
 * @note      opcode_h.mst 와 동일 구조. 버퍼 뒤에 append
 *

...
필드 형식: iem_cd 6자리 그대로(예: 005930), orr_pr 원 단위 정수(예: 70000).
지정가는 nmn_pr_tp_cd='01' + orr_pr, 시장가는 '05'(orr_pr 생략).
"""
import os, sys
...
def order_cash_buy(act_no: str, iem_cd: str, orr_qty: int,
...
if __name__ == "__main__":
    # 기본은 드라이런(전송 안 함). 실제 전송하려면 dry_run=False.
    print(order_cash_buy("여기에_계좌번호", "005930", 1, orr_pr=70000, dry_run=True))
